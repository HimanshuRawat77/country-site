...
filterByRegion.addEventListener("change",(e) => {
    ...
    let filteredCountries = countriesData.filter((country) => country.region == selectedCountry);
    // console.log(filteredCountries);
...
search.addEventListener("click",()=>{
  ...
  const textArea=document.querySelector("#countrysearch");
  const textInput =textArea.value;
  // console.log(textInput); 
  let searchedCountries = countriesData.filter((country) => country.name.toLowerCase().includes(textInput.toLowerCase()));
...
//   favDiv.append(e.target.parentElement);
...
//   favContainer.append(e.parentElement);
// });
...
function renderFavoriteCountries(countryCard){
  // favContainer.innerHTML='';
    ...
    // countryCard.href = `/country.html?name=${country.name}`
    favCard.innerHTML = countryCard.innerHTML;
    console.log(favCard);
    favContainer.appendChild(favCard);
    favContainer.style.display = "flex";
    favCard.style.display="inline-block";
    console.log(favContainer);
  }

const favButton = document.querySelectorAll("#favorite");
favButton.forEach(item=>item.addEventListener("click",(e)=>{
  // favContainer.style.display="block";
  renderFavoriteCountries(e.target.parentElement.parentElement);
